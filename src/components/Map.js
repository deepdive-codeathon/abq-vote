...
import fetchVotingLocations from '../services/Api/fetchVotingLocations';
...
export default class Map extends React.Component {
  ...
  render() {
    ...
    return (
      <MapView style={styles.map} initialRegion={this.state.viewingRegion}>
